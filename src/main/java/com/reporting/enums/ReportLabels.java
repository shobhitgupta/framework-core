...
public enum ReportLabels {
	HEADER_TEXT("ATU Graphical Reports for Selenium -  TestNG"), PASS("Passed"), FAIL("Failed"), SKIP("Skipped"), X_AXIS(
			"Run Number"), Y_AXIS("TC Number"), LINE_CHART_TOOLTIP("Test Cases"), LOGO_RIGHT(""), LOGO_RIGHT_CAPTION(
					"<i style=\"float:left;padding-left:20px;font-size:12px\"></i>"), LOGO_LEFT(""), LOGO_LEFT_CAPTION(
							"<i style=\"float:left;padding-left:20px;font-size:12px\"></i>"), PIE_CHART_LABEL(
									"Test Cases Percent Distribution"), TC_INFO_LABEL("Requirement Coverage/Build Info/Cycle - ");
