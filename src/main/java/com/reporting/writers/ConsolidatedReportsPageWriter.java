...
public class ConsolidatedReportsPageWriter extends ReportsPage {
	public static void menuLink(PrintWriter paramPrintWriter, int paramInt) {
		paramPrintWriter
				.println("\n            <tr id=\"container\">\n                <td id=\"menu\">\n                    <ul> \n");
		paramPrintWriter
				.println(" <li class=\"menuStyle\"><a href=\"../index.html\" >Index</a></li>\n");
		if (paramInt == 1) {
			paramPrintWriter.println("\n <li class=\"menuStyle\"><a href=\"" + Directory.RUNName
					+ paramInt + Directory.SEP + "CurrentRun.html\" >" + "Run " + paramInt
					+ " </a></li>\n");
		} else {
 ...
 * 
 * Qualified Name: atu.testng.reports.writers.ConsolidatedReportsPageWriter
 * 
