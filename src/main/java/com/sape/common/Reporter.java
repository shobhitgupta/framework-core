...
public class Reporter {
	...
	public void pass() {
		report("", "", "Should be successful", "Is successful", LogAs.PASSED, new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
	}

	public void fail() {
		report("", "", "Should be successful", "Is successful", LogAs.FAILED, new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
	}
