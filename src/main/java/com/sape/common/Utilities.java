...
public class Utilities {
    ...
    public boolean click(By by, boolean jsClick) {
        try {
            ...
            if (element == null) {
                Reporter.fatal("unable to locate element for clicking. " + by.toString(), null);
            }
    ...
    public boolean verifyListSorting(List<String> list, int startIndex) {
        Reporter.vrfy("Start index " + startIndex + " should not be less than 1", true, startIndex >= 1, null);
