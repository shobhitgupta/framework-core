...
public class Utilities {
     ...
     * @param jsClick
     *            if true, javascript click is performed, else
     *            <i> org.openqa.selenium.WebElement.click() </i>method is used
     * @author Abhishek Pandey
     */
     ...
     * @author Sagar Wadhwa
     */
    public boolean isSorted(String[] data) {
     ...
     * parent, -1)}
     * 
     * @author Sagar Wadhwa @since(04-Mar-2015)
     */
     ...
     * getElement(parent))}
     * 
     * @author Sagar Wadhwa @since(20-Mar-2015)
     */
     ...
     * getElement(parent))}
     * 
     * @author Sagar Wadhwa @since(24-Mar-2015)
     */
    ...
    public List<String> getTextFromList(List<WebElement> elements, boolean ignoreBlanks) {
        return getTextFromList(elements, ignoreBlanks, "", "");
    }

    public List<String> getTextFromList(List<WebElement> elements, boolean ignoreBlanks, String regex, String replacement) {
    ...
    public WebElement getElementWithText(List<WebElement> elements, String expText) {
        for (WebElement element : elements) {
